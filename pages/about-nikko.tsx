          ...
          <div className="w-full">
            ...
            <div className="flex flex-wrap justify-between">
              {aboutnikko[0].services.map((service: any) => (
                <div className="w-full md:w-1/2 pr-5 border-2 border-dark-blue hover:bg-zinc-900 hover:border-emerald-900 ease-in duration-300 p-10" key={service._key}>
                    ...
                    {service.serviceTools.map((serviceTools: any) => (
                      <li className="text-gray-700 text-md rounded-md">{serviceTools}</li>
                    ))}
                    </ul>
                </div>
              ))}
