    ...
    <div>
      ...
      <div className="w-full min-h-screen bg-dark-blue">
        ...
        <main className="py-5 px-8 mx-auto max-w-7xl">
          ...
          <div className="flex flex-wrap items-center flex-auto justify-center flex-col sm:flex-row">
              ...
              <Link key={project._id} href={`/project/${project.slug}`}>
                <div className="mb-12 text-center w-full md:w-1/2 xl:w-1/3 min-h-max">
                  <div className="m-4 mb-3 align-middle flex items-center justify-center rounded-md cursor-pointer bg-gray-900 border-2 border-gray-900 hover:bg-dark-blue hover:border-emerald-900 ease-in duration-300 aspect-square">
                    <img
                      className="w-1/2 object-contain align-middle"
                      src={urlFor(project.projCover).url()}
                      alt={project.projTitle}
                    />
                  </div>
                  <h3 className="text-2xl text-gray-300 font-bold cursor-pointer hover:text-emerald-500 ease-in-out duration-300">
                    {project.projTitle}
                  </h3>
                  <h4 className="text-md text-gray-600 cursor-pointer mt-1">
                    {project.projIndustry}
                  </h4>
                  <h4 className="font-light text-sm text-emerald-700 cursor-pointer mt-5">
                    {project.date}
                  </h4>
                </div>
              </Link>
